ifneq ($(wildcard device/motorola/common/hardware/qcom/custom.mk),)
    include device/motorola/common/hardware/qcom/custom.mk
else
# Board platforms lists to be used for
# TARGET_BOARD_PLATFORM specific featurization
QCOM_BOARD_PLATFORMS += msm8998 sdm660 sdm845 sm6125 sm6350 sm8150 sm8250 sm8350 holi
...
QCOM_NEW_MEDIA_PLATFORM := sdm845 sm6125 sm6350 sm8150 sm8250 sm8350 holi

#List of targets that use video hw
MSM_VIDC_TARGET_LIST := msm8998 sdm660 sdm845 sm6125 sm6350 sm8150 sm8250 sm8350 holi

#List of targets that use master side content protection
MASTER_SIDE_CP_TARGET_LIST := msm8998 sdm660 sdm845 sm6125 sm6350 sm8150 sm8250 sm8350 holi

ifneq ($(filter $(QCOM_NEW_MEDIA_PLATFORM), $(TARGET_BOARD_PLATFORM)),)
QCOM_MEDIA_ROOT := vendor/qcom/opensource/media/sm8350
else
